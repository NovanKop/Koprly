    ...
    const handleAuth = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (err.message === 'Invalid login credentials') {
                ...
                setError('Email Account unregistered yet, sign up first');
            } else {
                            ...
                            {authMode === 'signup' && !isForgotPassword && (
                                ...
                                >
                                    ...
                                    <button
                                        ...
                                        className="w-full flex items-center justify-center gap-3 py-3 px-4 rounded-xl border border-border-color bg-surface hover:bg-surface/80 transition-all hover:scale-[0.98] active:scale-[0.96] disabled:opacity-50 disabled:cursor-not-allowed"
                                    >
                                        {isGoogleLoading ? (
