                        ...
                        <div className="relative z-10">
                            ...
                            <div className="w-full">
                                ...
                                <div className="relative">
                                    ...
                                    {wallets.length > 1 && (
                                        <div className="absolute right-0 top-0 bottom-2 w-20 bg-gradient-to-l from-white via-white/60 to-white/0 dark:from-[rgba(23,31,41,0.8)] dark:via-[rgba(23,31,41,0.4)] dark:to-[rgba(23,31,41,0)] pointer-events-none flex items-center justify-end pr-2 rounded-r-xl">
